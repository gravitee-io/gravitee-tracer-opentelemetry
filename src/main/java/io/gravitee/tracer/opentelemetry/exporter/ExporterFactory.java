...
public class ExporterFactory {
    ...
    private static Map<String, String> populateTracingExportHttpHeaders(OpenTelemetryTracerConfiguration tracerConfig) {
        ...
        // headersMap.put(HttpHeaderNames.AUTHORIZATION.toString(), "ApiKey emJyMVVvOEJva1Q4dmJOWG42TDM6S2hPODV1R0JUSDJ2b3pxWnkxQjhldw==");
        // TODO: to complete
        /*
        OtlpUserAgent.addUserAgentHeader(headersMap::put);
        if (tracerConfig.headers().isPresent()) {
            List<String> headers = tracerConfig.headers().get();
            if (!headers.isEmpty()) {
